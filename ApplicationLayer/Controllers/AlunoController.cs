...
namespace ApplicationLayer.Controllers
{
    ...
    {         
		...
		/// <summary>
		/// Método responsável por buscar todos os dados do aluno pela matricula
		/// </summary>
		/// <returns>200, 400</returns>
		[HttpGet("find/{Matricula}")]
		[SwaggerOperation("Busca os dados do aluno pela matricula")]
		[SwaggerResponse(200)]
		[SwaggerResponse(400)]
		public async Task<ActionResult<IEnumerable<Aluno>>> BuscaAlunoNotas([FromRoute] string matricula)
		{
			var alunosNotas = await _alunoService.BuscaAlunoNotas(matricula);

			return Ok(alunosNotas);
		}
		...
		/// </summary>
		/// <param name="aluno">Objeto de aluno</param>
